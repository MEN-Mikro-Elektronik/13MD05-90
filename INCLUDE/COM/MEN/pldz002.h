...
/* 16Z002-02 (A22) */
#ifdef _16Z002_02
	#define PLDZ002_DEV_ID			0x4d45
	#define PLDZ002_VEN_ID			0x1a88
	#define PLDZ002_SUBSYS_VEN_ID	0x5a91
	#define PLDZ002_SUBSYS_ID		0x00be
#else
	#define PLDZ002_DEV_ID			0x5056
	#define PLDZ002_VEN_ID			0x1172
	#define PLDZ002_SUBSYS_VEN_ID	0x3032
	#define PLDZ002_SUBSYS_ID		0x7a30
#endif
...
/* 16Z002-02 (A22) */
	...
	#define PLDZ002_CTRL_SPACE		0x00030000	/**< Bridge Ctrl-Reg - offset				*/
	#define PLDZ002_IACK_SPACE		0x00030080	/**< IACK space - offset					*/

	/* BAR1 */
	#define PLDZ002_LRAM_SPACE		0x00000000	/**< Local RAM - offset						*/

	/* BAR2 */
	#define PLDZ002_A24D16_SPACE	0x00000000	/**< A24D16 (standard) space - offset		*/
	#define PLDZ002_A24D32_SPACE	0x01000000	/**< A24D32 (standard) space - offset		*/
		
	/* BAR3 */
	#define PLDZ002_A32D32_SPACE	0x00000000	/**< A32D32 (long) space - offset			*/
	#define PLDZ002_A32D32_SIZE		0x08000000	/**< A32D32 (long) space - size (128MB)		*/
	...
	#define PLDZ002_A16D16_SPACE	0x01000000	/**< A16D16 (short) space - offset			*/
	#define PLDZ002_A16D32_SPACE	0x01010000	/**< A16D32 (short) space - offset			*/

	#define PLDZ002_LRAM_SPACE		0x01400000	/**< Local RAM - offset						*/

	#define PLDZ002_CTRL_SPACE		0x01800000	/**< Bridge Ctrl-Reg - offset				*/

	/* PLD-Rev >= 17: no bridge internal RAM! */
	#if PLDZ002_REV < 17
		#define PLDZ002_IRAM_SPACE		0x01800800	/**< Bridge internal RAM - offset			*/
		#define PLDZ002_IRAM_SIZE		0x00000800	/**< Bridge internal RAM - size (2kB)		*/

		#define PLDZ002_CTRL_IRAM_SPACE \
			PLDZ002_CTRL_SPACE						/**< Bridge Ctrl-Reg & Int-RAM - offset		*/
		#define PLDZ002_CTRL_IRAM_SIZE	0x00001000	/**< Bridge Ctrl-Reg & Int-RAM - size (4kB)	*/
	#endif

	#define PLDZ002_IACK_SPACE		0x01c00000	/**< IACK space - offset					*/

	/*--- address spaces within BAR1 (swapped access) and BAR3 ---*/
	#define PLDZ002_A32D32_SPACE	0x00000000	/**< A32D32 (long) space - offset			*/
	#define PLDZ002_A32D32_SIZE		0x20000000	/**< A32D32 (long) space - size (512MB)		*/

	/*--- address spaces within BAR4 ---*/
	#define PLDZ002_A24D32SW_SPACE	0x00000000	/**< A24D32 (standard) space swapped - offset	*/
	#define PLDZ002_A24D32_SPACE	0x01000000	/**< A24D32 (standard) space - offset			*/
...
#ifdef _16Z002_02
	#define PLDZ002_MSTR_A16_MODE_MASK	0x00000300	/**<	A16 mode mask	*/
	#define PLDZ002_MSTR_A24_MODE_MASK	0x00000C00	/**<	A24 mode mask	*/
	#define PLDZ002_MSTR_A32_MODE_MASK	0x00003000	/**<	A32 mode mask	*/
	#define PLDZ002_MSTR_A16_MODE( mode )	( (((mode) & 0x07) >> 1) << 8 )
	#define PLDZ002_MSTR_A24_MODE( mode )	( (((mode) & 0x07) >> 1) << 10 )
	#define PLDZ002_MSTR_A32_MODE( mode )	( (((mode) & 0x07) >> 1) << 12 )
#else
...
/* CTRL 0x1C */
#define PLDZ002_LONGADD			0x001c		/**< Upper 1..8 Address Bits for A32 (r/w)		*/
/* 16Z002-02 (A22) */
#ifdef _16Z002_02
	#define PLDZ002_LONGADD_UPPER	5		/**< used upper address bits */
	#define PLDZ002_LONGADD_SHIFT \
		(8 - PLDZ002_LONGADD_UPPER)			/**< shift of addr bits in reg */
#else
	#define PLDZ002_LONGADD_UPPER	3		/**< used upper address bits */
	#define PLDZ002_LONGADD_SHIFT	0		/**< shift of addr bits in reg */
#endif

/* get upper 1..8 address bits from VME address */
#define PLDZ002_LONGADD_ADR(vmeAddr) \
	((vmeAddr) >> (32 - PLDZ002_LONGADD_UPPER))
...
#define PLDZ002_PCI_OFFSET_ALN	0x1000		/**< 4kByte alignment for PCI offset */
...
/* 16Z002-02 (A22) */
	...
	#define PLDZ002_DMASTA_ACT_BD(dmasta) \
		(((dmasta)&0xff00)>>8)				/**<	returns number of active buffer descriptor */
#else
	#define PLDZ002_DMASTA_ACT_BD(dmasta) \
...
#define PLDZ002_RV11_SRAMREGS 	0xff800					/**< start of "regs" in SRAM  (last 2kB) */
#define PLDZ002_LRAM_USERSIZE	PLDZ002_RV11_SRAMREGS	/**< Local RAM - user size (1022kB) */
...
#define PLDZ002_DMABD_SIZE 		(sizeof(PLDZ002_DMABD))		/**< size of one Buffer Descriptor */

/* 16Z002-02 (A22) */
#ifdef _16Z002_02
	#define PLDZ002_DMA_MAX_BDS		112		/**< max number of BDs */
#else
	#define PLDZ002_DMA_MAX_BDS		16		/**< max number of BDs */
#endif

#define PLDZ002_DMA_MAX_MBX			4		/**< max number of Mailboxes */
