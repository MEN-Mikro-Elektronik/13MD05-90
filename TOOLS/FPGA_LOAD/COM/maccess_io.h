#ifndef _MACCESS_IO_H
#define _MACCESS_IO_H
...
__inline u_int8 MREAD_IO_D8(MACCESS ma, u_int32 offs) {
	return MREAD_D8(ma, offs);
}
__inline u_int16 MREAD_IO_D16(MACCESS ma, u_int32 offs) {
	return MREAD_D16(ma, offs);
}
__inline u_int32 MREAD_IO_D32(MACCESS ma, u_int32 offs) {
	return MREAD_D32(ma, offs);
}

__inline void MWRITE_IO_D8(MACCESS ma, u_int32 offs, u_int32 val) {
	MWRITE_D8(ma, offs, val);
	return;
}
__inline void MWRITE_IO_D16(MACCESS ma, u_int32 offs, u_int32 val) {
	MWRITE_D16(ma, offs, val);
	return;
}
__inline void MWRITE_IO_D32(MACCESS ma, u_int32 offs, u_int32 val) {
